  ...
  async fetch(req, env) {
    ...
    if (action === 'pullData') {
      ...
      if (rec.role === 'judge') {
        ...
        return json({ ok: true, data: { cases: myCases, contacts: myContacts, partyRequests: myReqs, targets: myTargets, deletedTargetIds: snap.deletedTargetIds || [], deletedCaseIds: snap.deletedCaseIds || [], settings: safeSettings, roster, judge: true, updatedAt: snap.updatedAt } });
      }
      ...
      return json({ ok: true, data: { cases: myCases, contacts: myContacts, partyRequests: myReqs, deletedCaseIds: snap.deletedCaseIds || [], participant: true, updatedAt: snap.updatedAt } });
    }
